<?php
	...
	switch ($_REQUEST['exec'])
	{
		...
		case "show_portfolio_list" :
			...
			$innerHTML	.= "<th>웹 이미지</th>";
			$innerHTML	.= "<th>모바일 메인 이미지</th>";
			$innerHTML	.= "<th>모바일 중간 이미지1</th>";
			$innerHTML	.= "<th>모바일 중간 이미지2</th>";
			$innerHTML	.= "<th>모바일 중간 이미지3</th>";
			$innerHTML	.= "<th>모바일 웹 이미지</th>";
			$innerHTML	.= "<th>등록일</th>";
			$innerHTML	.= "</tr>";
			$innerHTML	.= "</thead>";
			$innerHTML	.= "<tbody>";
			...
			while ($list_data = mysqli_fetch_array($list_result))
			{
				...
				$innerHTML	.= "<td><img src='".str_replace("../../../","../../",$list_data['web_image'])."' width='80px'></td>";
				$innerHTML	.= "<td><img src='".str_replace("../../../","../../",$list_data['m_main_image'])."' width='80px'></td>";
				$innerHTML	.= "<td><img src='".str_replace("../../../","../../",$list_data['m_middle_image1'])."' width='80px'></td>";
				$innerHTML	.= "<td><img src='".str_replace("../../../","../../",$list_data['m_middle_image2'])."' width='80px'></td>";
				$innerHTML	.= "<td><img src='".str_replace("../../../","../../",$list_data['m_middle_image3'])."' width='80px'></td>";
				$innerHTML	.= "<td><img src='".str_replace("../../../","../../",$list_data['m_web_image'])."' width='80px'></td>";
