...
<!-- /.navbar-static-side -->
  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Contact us 리스트</h1>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- /.row -->
      ...
      <div class="panel-body">
        <div class="panel-body">
          ...
          <div class="table-responsive">
            <table width="100%" class="table table-striped table-bordered table-hover" id="contact_list">
            </table>
          </div>
          <!-- /.table-responsive -->
        </div>
...
?>
	...
	$(document).ready(function() {
		...
		//show_portfolio_list("contact_list");
